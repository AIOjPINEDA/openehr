# Module 2 Curriculum Mapping - OpenEHR Bootcamp

## Objective
Map and structure Module 2 contents to avoid repetition and maximize academic value of each class.

## Identified Curriculum Structure

### 🎯 **Phase 1: Fundamentals and Concepts** (Videos 1-13)
| Topic | Description | Status | Document Location |
|-------|-------------|--------|-------------------|
| Build your first openEHR app | General module introduction | ✅ **COMPLETED** | `module-2-00-kickoff-unified-summary.md` |
| What you'll be building | Final project specification | ✅ **COMPLETED** | `module-2-00-kickoff-unified-summary.md` |
| Module 2 - Kick off | Official module presentation | ✅ **COMPLETED** | `module-2-00-kickoff-unified-summary.md` |
| Templates, EHRs and Compositions | Core OpenEHR concepts | ✅ **COMPLETED** | `module-2-00-kickoff-unified-summary.md` |
| Example Composition API | Practical API introduction | ✅ **COMPLETED** | `module-2-01-creating-compositions-api.md` |
| Create composition API (Canonical JSON) | Traditional OpenEHR format | ✅ **COMPLETED** | `module-2-01-creating-compositions-api.md` |
| Create Composition API (FLAT JSON) | Simplified format | ✅ **COMPLETED** | `module-2-01-creating-compositions-api.md` |
| Retrieve Composition API | Data reading | ✅ **COMPLETED** | `module-2-02-retrieving-and-updating-compositions.md` |
| Update Composition API | Data modification | ✅ **COMPLETED** | `module-2-02-retrieving-and-updating-compositions.md` |
| Retrieve particular version | Composition versioning | ✅ **COMPLETED** | `module-2-02-retrieving-and-updating-compositions.md` |
| Composition API - Deleting | Data deletion | ✅ **COMPLETED** | `module-2-02-retrieving-and-updating-compositions.md` |
| Iterate and Fail | Development methodology | 🔄 **PENDING** | *Not yet documented* |
| Official openEHR API specs | Official documentation | 🔄 **PENDING** | *Not yet documented* |

### 🛠️ **Phase 2: Implementation Techniques** (Videos 14-16)
| Topic | Description | Status | Document Location |
|-------|-------------|--------|-------------------|
| Techniques for building your app | Development strategies | ✅ **COMPLETED** | `module-2-03-development-techniques-comparison.md` |
| Technique 1 - Use example composition | Example-based approach | ✅ **COMPLETED** | `module-2-03-development-techniques-comparison.md` |
| Technique 2 - Use Medblocks UI | Specialized components | ✅ **COMPLETED** | `module-2-05-technique-medblocks-ui.md` |
...
| [Tutorial] Clean up and updating compositions | Data maintenance | ✅ **COMPLETED** | `module-2-04-tutorial-implementation-medblocks-ui.md` |

### 🚀 **Phase 4: Advanced Topics** (Videos 22-29)
| Topic | Description | Status | Document Location |
|-------|-------------|--------|-------------------|
